...
<style>
    ...
    @font-face {
        font-family: 'Gravity';
        src: url('wof/assets/GravityBold8.ttf') format('truetype');
    }
    @font-face {
        font-family: 'Born2bs';
        src: url('wof/assets/Born2bSportyV2.ttf') format('truetype');
    }
    @font-face {
        font-family: 'helvb';
        src: url('wof/assets/helvb08.ttf') format('truetype');
    }
    @font-face {
        font-family: 'Haxr';
        src: url('wof/assets/haxrcorp-4089.ttf') format('truetype');
    }
    .container-fluid {
        padding-right: 20px;
        padding-left: 20px;
...
<script type="text/javascript" src="wof/assets/wof_ui.js"></script>
{% endblock %}
"""
